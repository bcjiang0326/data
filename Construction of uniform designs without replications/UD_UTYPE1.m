function [x wd2 info] = UD_UTYPE1(q0,beq,x0,upperbnd,lowerbnd,opt0)
% 2012/4/24 2012/4/25
...
INT = -1;
narginchk(3+INT, 7+INT);%, nargin, 'struct'));
...
if t < opt(3)
    ...
    upperbnd1 = rec_Branchbound( splt+1, updtLc(LelCom),...
        f(splt-bgn+2:end,1)+H(splt+1:end,splt), beq-1,...
        upperbnd-C, lowerbnd-C );
    if info1(6) == 0
...
% Rule0和Rule2中元素相等并且等于1时才能判断出 Judge0 = 0
