...
fprintf('WD:\n');
outfile = fopen('MA LHD 20150126/result_WD_20150525.txt','w');
...
for lop = 1:length(name)
    ...
    for n = 3:2:9
        ...
        t0 = cputime;
        [Disc0, Disc_vec0] = TA_WD_LHD_1(groups,D,q_oa,OutIter,InIter,T0,T1,Reps,0);
        t0 = cputime-t0;
        ...
        for rep = 1:Reps
            ...
            tt = cputime;
            Disc_vec1(rep) = TA_WD_LHD_1(groups,D,q_oa,OutIter,InIter,T0,T1,1,0);
            tt = cputime-tt;
        ...
        t2 = cputime;
        [Disc2, Disc_vec2, L2,K] = TA_WD(N,q_lh,OutIter,InIter,T0,T1,Reps,0);
        t2 = cputime-t2;
