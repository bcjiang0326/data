function [aveDisc0,cols0,WB0,A0,D0] = minAveDiscSubDesign(D,q0,DiscMeasure,OutIter,InIter,T0,T1,writedata)
% 20160518 Xiaopang
...
% 更新一次阈值 T = T*ratio
if T0 ~= 0
    ratio = (T1/T0)^(1/(OutIter-1));
else
    ratio = 1;
end
T = T0;
for Oiter = 1:OutIter*InIter
