function [Disc0, Disc_vec, L0] = TA_MD_LHD(D,q,OutIter,InIter,T0,T1,Reps,writedata,flag)
% 20150126 
% 基于 TA 算法求解均匀 LHD
...
%ratio = (T0-T1)/(ceil(OutIter/InIter)-1);
...
OutIter = 100*InIter;
Reps = 3;
[Disc0, Disc_vec, L0] = TA_MD_LHD(D0,q,OutIter,InIter,1e-3,1e-6,Reps,0,0);
fprintf('%.8f\n',Disc0);
